...
- Visual Studio Code에서 MySQL 연동
    ...
    - SQL 기초
        ...
        - DML INSERT, UPDATE, DELETE: [SQL](./day03/db02_DML_query.sql)
            ...
            VALUES(값리스트); -- VALUE 는 SQL표준이 아님(MySQL, PostgreSQL 등에서만 사용가능)
...
- SubQuery 고급 : [SQL](./day03/db03_sql_high_grade_subquery.sql)
...
- 데이터모델링 실습
    - 병원업무관리 ERD
        ...
        - Workbench에서 DB생성 후 위 스크립트 실행. DB구현 [SQL](./day08/db03_병원업무관리_데이터입력.sql)

    <img src="./image/hos_erd.png" width="800">
...
- tkinter DB연동 GUI앱 개발
    ...
    3. tkinter 템플릿코드 작성 - 기본적인 GUI앱 틀
        ...
        <img src="./image/db_tkinter.png" width="700">
    
    4. 데이터베이스 CRUD 함수 구현
        
        <img src="./image/python_sql_connection.png" width="700">
